...
import { useOutsideClick } from "./OutsideClick"; // Assuming useOutsideClick is in the hooks folder
  ...
  return (
    <>
      ...
      >
        ...
        {/* Normal Image (Replaced Next.js Image) */}
        <img src={card.src} alt={card.title} className="object-cover absolute z-10 inset-0 w-full h-full" />
      </motion.button>
    </>
  );
};
