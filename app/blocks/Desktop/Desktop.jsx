  ...
  return (
    <div className="relative [perspective:800px]">
      <div
        ...
        className="h-[12rem] w-[32rem]  rounded-2xl p-2 relative border-4 border-gray-800"
      >
        <div
          style={{
            boxShadow: "0px 2px 0px 2px var(--neutral-900) inset",
          }}
          className="absolute inset-0 bg-[#000000] rounded-lg flex items-center justify-center"
        >
